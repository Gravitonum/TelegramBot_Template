...
async def about(update, context: ContextTypes.DEFAULT_TYPE) -> None:
    about_text = (
        ...
        "- /compaer — сравнить выбранное колесо с последним\n\n"
        ...
        "- Команда /compaer сравнивает ‘последнее открытое’ с предыдущим календарным месяцем; если месяц совпадает — предупредит\n"
        "- Если ‘последнее открытое’ не задано, бот подберет ближайшую пару\n\n"
        "<b>Удаление данных</b>\n"
        "- /clean или /clear — удалить конкретное колесо или все\n"
